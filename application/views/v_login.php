...
<head>
  <title>Login - Perpustakaan SMP GELORA</title>
...
<body class="bg-dark">
  ...
  <div class="container">
    ...
    <h2 class="font-weight-normal text-center text-white">PERPUSTAKAAN</h2>
    <h3 class="font-weight-normal text-center text-white">SMP GELORA</h3>
